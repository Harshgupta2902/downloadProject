                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php foreach ($blogs as $blog) { ?>
                      ...
                      <td class="align-middle">
                        <a href="<?php echo base_url('Admin/deleteBlog/').urlencode($blog['id']) ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Delete
                        </a>
                      </td>
                    </tr>
