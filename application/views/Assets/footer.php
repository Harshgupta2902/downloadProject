...
<footer class="px-4 pt-12 pb-8 text-white border-t border-gray-200">
        <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
            <div class="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
                <a href="" class="flex justify-start block text-left sm:text-center lg:text-left sm:justify-center lg:justify-start">
                    ...
                    <span class="ms-4 font-weight-bold" style="color:black">GetItFast</span>
                </a>
            ...
            <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    ...
                    <li><a href="<?php echo base_url() ?>"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Windows</a>
                    </li>
                    <li><a href="<?php echo base_url() ?>"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Mac</a>
                    </li>
                    <li><a href="<?php echo base_url() ?>"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Ios</a>
                    </li>
                    <li><a href="<?php echo base_url() ?>"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Android</a></li>
                </ul>
                <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        Blogs</li>
                    <li><a href="<?php echo base_url() ?>"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Latest Blog</a>
                    </li>
                    <li><a href="<?php echo base_url() ?>" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">New Blogs</a></li>
                </ul>
        ...
        <div class="pt-4 pt-6 mt-10 text-center text-gray-500 ">© 2023 All rights reserved.</div>
    </footer>